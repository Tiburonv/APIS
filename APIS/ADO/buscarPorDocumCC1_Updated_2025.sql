...
/****** Object:  StoredProcedure [dbo].[buscarPorDocumCC1]    Script Date: 06/11/2025 15:49:46 ******/
SET ANSI_NULLS ON
GO
...
-- SP ACTUALIZADO - Versión sin parámetro @cantidad
-- Modificado el 06/11/2025
-- Cambios principales:
-- 1. Eliminado el parámetro @cantidad
-- 2. Ahora solo acepta @consulta y @usuario
-- 3. Incluye UNION ALL entre DocumentoCalculado (FACT, N/CR) y PedidoCalculado (PED)
-- 4. Orden por Dias DESC para mezclar todos los tipos de documentos
